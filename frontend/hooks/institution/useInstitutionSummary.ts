...
import { fetchInstitutionSummary } from "../../app/(locale)/(private)/institution/[id]/services/institutionService"
import type { InstitutionSummaryDto } from "../../app/(locale)/(private)/institution/[id]/schema/institutionSchema"
