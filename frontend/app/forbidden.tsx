...
export default function Forbidden({
    ...
    return (
        <div className="h-full w-full flex items-center justify-center px-6 bg-gradient-to-b from-background to-muted/40">
            <motion.div
            ...
            >
                ...
                <p className="text-muted-foreground mb-6">
                    ...
                    Caso ache que isso é um erro, fale com o administrador.
                </p>
