...
class LogService {
 ...
 // HTTP error constants
  ...
  public const HTTP_413 = "413 Payload Too Large: The request is larger than the server is willing or able to process.";
  ...
  public static function http413(string $route, ?string $additionalMessage = null): void {
    self::error($route, self::HTTP_413 . self::appendMessage($additionalMessage));
  }
